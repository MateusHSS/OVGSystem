            ...
            $(".detalhes").click(function() {
                    $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $("#dimensao_detalhes").text((retorno.largura + " X " + retorno.altura + " X " + retorno.espessura).replace(".", ","))
                                $("#atividade_detalhes").text(retorno.nomeatividade); $("#seguranca_detalhes").text(retorno.nomeseguranca);
                                    if (retorno.formulariopedido != null) {
