        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (item in response) {
                    ...
                    html +=
                        "<td class='edita'><a href='#edita" +
                        response[item].idproduto +
                        "' class='modal-trigger orange-text text-darken-3'><i class='material-icons'>create</i></a></td>"
                    html += "</tr>"
                    html +=
                    ...
                    html +=
                        "<form method='post' action='../controller/update/editaProduto.php?id=" +
                        response[item].idproduto +
                        "' id='form-edita" +
                        response[item].idproduto +
                        "'>"
                    ...
                    html +=
                        ...
                        response[item].idproduto +
                        "' type='text' class='validate' name='nome-produto' value='" +
                        response[item].idproduto +
                    ...
                    html +=
                        "<div class='btn light-blue darken-3 botao' type='submit' name='action' id='" +
                        response[item].idproduto +
                        "'>Atualizar<i class='material-icons right'>check</i></div>"
                    html += "</div>"
                    html += "</form>"
                    html += "</div>"
                    html += "</div>"
