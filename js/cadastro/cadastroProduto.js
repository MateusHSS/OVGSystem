...
$(document).ready(function() {
    ...
    $(".add").click(function(e){ //on add input button click
        ...
        $(wrapper).append('<div><div class="input-field col l4"><input type="text" class="autocomplete material" id="nome_material_'+pos+'" name="material['+pos+'][nome]"/><label for="nome_material_'+pos+'">Material</label><span class="helper-text right red-text remove" style="cursor: pointer;" data-pos="'+pos+'">Remover</span></div><div class="input-field col l1"><input type="text" class="validate qtd" id="qtd_material_'+pos+'" name="material['+pos+'][qtd]"><label for="qtd_material_'+pos+'">Quantidade</label><span class="helper-text"></span></div>'); //add input box
        ...
        $(".remove").click(function(e){ //user click on remove text
            ...
            $("#qtd_material_"+pos).parent('div').remove(); 
            x--;
        });
