<?php
    ...
    $sqlSelecionaProcessosProduto = $connect->prepare("SELECT DISTINCT tabprocessosproduto.idprocesso, tabprocessosproduto.finalizado, tabprocesso.descricao FROM tabprocessosproduto
