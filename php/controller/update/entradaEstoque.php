<?php
    ...
    $sqlSelecionaIdEstoque->bind_param("s", $sap);
    ...
    $sqlInsereEstoque = $connect->prepare("UPDATE tabestoque SET quantidade = quantidade + $qtd, KG = KG + $peso, mm2 = (SELECT tabmaterial.mm2 FROM tabmaterial WHERE tabmaterial.codigo_SAP = $sap) * $qtd WHERE tabestoque.idtabestoque = $idEstoque");
