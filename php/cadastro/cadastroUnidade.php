...
<head>
    ...
    <title>OVGSYSTEM - Cadastro de unidade</title>
...
?>
    ...
    <main>
        <div class="container">
            ...
            <h4 class='center'>Cadastro de unidade</h4>
            <form action="../controller/insert/insereUnidade.php" method='post' class='center'>
                <div class="row">
                    <div class="input-field col m12">
                        <input id="nome-unidade" type="text" class="validate" name='nome-unidade'
                            onkeyup="this.value = this.value.toUpperCase();">
                        <label for="nome-unidade">Nome da unidade</label>
                    </div>
                </div>
