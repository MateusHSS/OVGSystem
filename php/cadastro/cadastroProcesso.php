...
<head>
    ...
    <title>OVGSYSTEM - Cadastro de processo</title>
...
?>
    ...
    <main>
        <div class="container">
            ...
            <h4 class='center'>Cadastro de processo</h4>
            <form action="" method='post' class='center' id="form_cadastro_processo">
                <div class="row">
                    <div class="input-field col m8">
                        <input id="descricao_processo" type="text" class="validate" name='descricao_processo'
                            onkeyup="this.value = this.value.toUpperCase();">
                        <label for="descricao-processo">Descrição do processo</label>
                    </div>
                    <div class="input-field col m4">
                        <input id="tempo_processo" type="text" class="validate" name='tempo_processo'
                            onkeyup="this.value = this.value.toUpperCase();">
                        <label for="tempo_processo">Tempo (h:min:seg)</label>
                    </div>
                </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.2/additional-methods.min.js"
        ...
        crossorigin="anonymous"></script>
    <script src="../../js/cadastro/cadastroProcesso.js"></script>
</body>
