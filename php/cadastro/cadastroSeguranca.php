...
<head>
    ...
    <title>OVGSYSTEM - Cadastro de atividade</title>
...
<header>
    ...
    <main>
        <div class="container">
            ...
            <h4 class='center'>Cadastro de segurança</h4>
            <form action="../controller/insert/insereSeguranca.php" method='post' class='center'>
                <div class="row">
                    <div class="input-field col m8">
                        <input id="descricao-seguranca" type="text" class="validate" name='descricao-seguranca'
                            onkeyup="this.value = this.value.toUpperCase();">
                        <label for="descricao-seguranca">Descrição da segurança</label>
                    </div>
                    <div class="input-field col m4">
                        <input id="peso-seguranca" type="text" class="validate" name='peso-seguranca'
                            onkeyup="this.value = this.value.toUpperCase();">
                        <label for="peso-seguranca">Peso</label>
                    </div>
                </div>
