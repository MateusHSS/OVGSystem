...
<head>
    ...
    <title>OVGSYSTEM - Cadastro de funcionário</title>
...
<header>
    ...
    <main>
        <div class="container">
            ...
            <h4 class='center'>Cadastro de funcionário</h4>
            <form action="" method='post' class='center' id="form_cadastro_funcionario">
                <div class="row">
                    <div class="input-field col l6">
                        <input id="nome_funcionario" type="text" class="validate" name='nome_funcionario'
                            onkeyup="this.value = this.value.toUpperCase();">
                        <label for="nome_funcionario">Nome completo</label>
                    </div>
                    <div class="input-field col l6">
                        <input id="matricula_funcionario" type="text" class="validate" name='matricula_funcionario'>
                        <label for="matricula_funcionario">Matrícula</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col l6">
                        <input id="empresa_funcionario" type="text" class="validate" name='empresa_funcionario'>
                        <label for="empresa_funcionario">Empresa</label>
                    </div>
                    <div class="input-field col l3">
                        <select name='turno_funcionario' id='turno_funcionario'>
                            ...
                            <?php
                                ...
                                while($res = $result->fetch_array()){
                                    ?>
                            <option value='<?php echo $res['idtabturno'] ?>'><?php echo $res['nometurno'] ?></option>
                            <?php
                                }
                            ?>
                        </select>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.2/additional-methods.min.js"
        ...
        crossorigin="anonymous"></script>
    <script src="../../js/cadastro/cadastroFuncionario.js"></script>
</body>
