        ...
        <div class="container">
            ...
            <form action="" method='post' class='center' id='form_pedido' enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="input-field col l3">
                        <input id="dimensao_pedido" type="text" class="validate" name='dimensao_pedido'
                            onkeyup="this.value = this.value.toUpperCase();">
                        <label for="dimensao_pedido" style="font-size: 90%;">Dimensionamento (em mm) (larg X alt X espess)</label>
                    </div>
                    <div class="input-field col l3">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <textarea id="obs_pedido" class="materialize-textarea" data-length="255" name="obs_pedido"></textarea>
