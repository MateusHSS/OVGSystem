...
<head>
    ...
    <title>OVGSYSTEM - Cadastro de status</title>
...
?>
    ...
    <main>
        <div class="container">
            ...
            <h4 class='center'>Cadastro de status de pedido</h4>
            <form action="../controller/insert/insereStatus.php" method='post' class='center'>
                <div class="row">
                    <div class="input-field col m12">
                        <input id="nome-status" type="text" class="validate" name='nome-status'
                            onkeyup="this.value = this.value.toUpperCase();">
                        <label for="nome-status">Nome do status</label>
                    </div>
                </div>
