...
<head>
    ...
    <title>OVGSYSTEM - Cadastro de material</title>
...
?>
    ...
    <main>
        <div class="container">
            ...
            <h4 class='center'>Cadastro de material</h4>
            <form action="" method='post' class='center' id="form_cadastro_material">
                <div class="row">
                    <div class="input-field col l2">
                        <input id="sap_material" type="text" class="validate" name='sap'
                            onkeyup="this.value = this.value.toUpperCase();">
                        <label for="sap_material">SAP</label>
                    </div>
                    ...
                    <div class="input-field col l2">
                        <input id="peso_material" type="text" class="validate" name='peso_material'
                            onkeyup="this.value = this.value.toUpperCase();">
                        <label for="peso_material">Peso p/ unid. (Kg)</label>
                    </div>
                </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.2/additional-methods.min.js"
        ...
        crossorigin="anonymous"></script>
    <script src="../../js/cadastro/cadastroMaterial.js"></script>
</body>
