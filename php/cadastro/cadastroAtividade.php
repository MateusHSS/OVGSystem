...
?>
    ...
    <main>
        <div class="container">
            ...
            <h4 class='center'>Cadastro de atividade</h4>
            <form action="" method='post' class='center' id="form_cadastro_atividade">
                <div class="row">
                    <div class="input-field col m8">
                        <input id="descricao_atividade" type="text" class="validate" name='descricao_atividade'
                            onkeyup="this.value = this.value.toUpperCase();">
                        <label for="descricao_atividade">Descrição da atividade</label>
                    </div>
                    <div class="input-field col m4">
                        <input id="peso_atividade" type="text" class="validate" name='peso_atividade'
                            onkeyup="this.value = this.value.toUpperCase();">
                        <label for="peso_atividade">Peso</label>
                    </div>
                </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.2/additional-methods.min.js"
        ...
        crossorigin="anonymous"></script>
    <script src="../../js/cadastro/cadastroAtividade.js"></script>
</body>
