                ...
                <div class="row" id='linha'>
                    <div class="row">
                        ...
                        <div class="input-field col l4">
                            <input id="nome_material_1" type="text" class="autocomplete material" name='material[1][nome]' material-id=""
                                onkeyup="this.value = this.value.toUpperCase();">
                            <label for="nome_material_1">Material</label>
                        </div>
                        <div class="input-field col l1">
                            <input id="qtd_material_1" type="text" class="validate qtd" name='material[1][qtd]'
                                onkeyup="this.value = this.value.toUpperCase();">
                            <label for="qtd_material_1">Quantidade</label>
                        </div>
