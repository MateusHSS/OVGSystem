                ...
                <div class="row">
                    <div class="col l12">
                        <table class="centered responsive-table card">
                            ...
                            $sql = $connect->prepare("SELECT tabestoque.*, tabmaterial.nomematerial, REPLACE(tabmaterial.peso_KG, '.', ',') AS peso_KG FROM tabestoque INNER JOIN tabmaterial ON tabmaterial.codigo_SAP = tabestoque.SAP_material");
                            $sql->execute();
