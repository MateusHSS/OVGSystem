    ...
    <main>
        <div class="container">
            ...
            <div class="row" id="listagem-pedidos">
                ...
                WHERE tabpedido.statuspedido = 1 ORDER BY tabpedido.emergencial, pesoTotal, tabpedido.datainclusao ASC");
                $sql->execute();
            ...
            <div class='modal-content'>
                ...
                <form method='post' action='' id='form_programa_pedido' data-id-pedido="" data-qtd-pedido="">
                    <div class="row">
                        <div class="col l6">
                            ...
                            <div class="row center">
                                <div class="col l4">
                                    ...
                                    <div class="switch">
                                        <label>
                                            <input type="checkbox" class="processos" name="processo[<?php echo $resProc['idtabprocesso'] ?>]" data-id-processo="<?php echo $resProc['idtabprocesso'] ?>" data-tempo-proc="<?php echo $resProc['tempo'] ?>">
                                ...
                                <div class="col l4">
                                    <div class="input-field">
                                        <input type="text" class="qtd" id="qtd_proc_<?php echo $resProc['idtabprocesso'] ?>"
                                ...
                                <div class="col l4">
                                    <div class="input-field">
                                        <input type="text" class="qtd" id="qtd_func_proc_<?php echo $resProc['idtabprocesso']?>"
                            ...
                            <div class="row">
                                <p>
                                    Tempo total: <span id="tempo_processo_<?php echo $resProc['idtabprocesso'] ?>"></span>
                                </p>
                            </div>
                            <div class="divider"></div>
                            <?php
                        ...
                        <div class="col l6">
                            <h5>Tempo por peça: <span data-mask="00:00:00"
                                    id="tempo_peca"></span></h5>
                            <h6>Tempo final do pedido:
                                <span data-mask="00:00:00" id="tempo_pedido"></span> </h6>
                        </div>
                    </div>
                    <div class="row center">
                        <button class='btn light-blue darken-3 botao' type='submit' name='action'>Programar
