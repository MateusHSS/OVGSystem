...
<head>
    ...
    <title>OVGSYSTEM - Atividades</title>
...
if($_SESSION['perfil'] == 1){
    ...
    <main>
        <div class="container">
            ...
            <div class="row">
                ...
                $sql = $connect->prepare("SELECT * FROM tabatividade");
                $sql->execute();
                $result = $sql->get_result();
                while($res= $result->fetch_assoc()){
                    ?>
                            <tr>
                                <td><?php echo $res['idtabatividade'] ?></td>
                                <td><?php echo $res['descricao'] ?></td>
                                <td><?php echo $res['peso'] ?></td>
    ...
    <script src="../../js/listas/listaAtividades.js"></script>
</body>
